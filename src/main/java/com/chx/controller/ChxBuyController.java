...
public class ChxBuyController {
    ...
    public String  pageSearch(@RequestParam(value="currentPage",defaultValue="1",required=false) int currentPage,@RequestParam(value="searchStr",defaultValue="",required=false) String searchStr,@RequestParam(value="shopcode",defaultValue="001",required=false) String shopcode,Model model){
