        ...
        <div class="col-md-12" style="text-align:center;">
            <form class="form-inline" action="${pageContext.request.contextPath }/chxm/search">
                ...
                <input type="button" value="添加+" class="btn btn-danger"
                       ...
                       onclick="location.href='<cr:url value="/chxm/add"></cr:url>'"/>
            </form>
        </div>
    </div>
            ...
            <div class="panel panel-default" style="margin-left:30px;margin-right:30px;">
                ...
                <div style="margin:10px;">
                    ...
                    <cr:if test="${requestScope.pagemsg.currPage != 1}">
                        <a href="${pageContext.request.contextPath }/chxm/search?currentPage=1&searchStr=${requestScope.pagemsg.searchStr}">[首页]</a>
                        <a href="${pageContext.request.contextPath }/chxm/search?currentPage=${requestScope.pagemsg.currPage-1}&searchStr=${requestScope.pagemsg.searchStr}">[上一页]</a>
                    </cr:if>

                    <cr:if test="${requestScope.pagemsg.currPage != requestScope.pagemsg.totalPage}">
                        <a href="${pageContext.request.contextPath }/chxm/search?currentPage=${requestScope.pagemsg.currPage+1}&searchStr=${requestScope.pagemsg.searchStr}">[下一页]</a>
                        <a href="${pageContext.request.contextPath }/chxm/search?currentPage=${requestScope.pagemsg.totalPage}&searchStr=${requestScope.pagemsg.searchStr}">[尾页]</a>
                    </cr:if>
                </span>
                </div>
            </div>
