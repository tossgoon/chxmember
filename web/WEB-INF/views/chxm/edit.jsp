...
<div class="container" style="width:100%;margin-bottom:160px;">
    <div class="row">
        <div class="col-md-12" style="text-align:center;">
            <div style="margin:0 auto;"><h3 style="font-weight:normal;float:left;">会员管理&gt;&gt;会员管理</h3></div>
        </div>
    </div>
    <hr/>
    <div class="row">
                        ...
                        <table style="border-collapse:separate; border-spacing:0px 10px;width:100%;" id="tbchxm">
                            ...
                            <tr>
                                ...
                                <td><input type="text" name="shopCode" id="shopCode"
                                           value="${chxm.shopCode}" readonly="readonly"
                                           class="form-control"/></td>
                            </tr>
                            <tr>
                                <td><span>会员卡号(*)</span></td>
                                <td><input type="text" name="cardId" id="cardId" value="${chxm.cardId}"
                                           class="form-control" required="true"/></td>
                            </tr>
                            <tr>
                                <td><span>姓名(*)</span></td>
                                <td><input type="text" name="memName" id="memName" value="${chxm.memName}"
                                           class="form-control" required="true"/></td>

                            </tr>
                            <tr>
                                <td><span>亲切称呼</span></td>
                                <td><input type="text" name="kindName" id="kindName" value="${chxm.kindName}"
                                           class="form-control"/></td>
                            </tr>
                            <tr>
                                <td><span>性别(*)</span></td>
                                <td><input type="radio" name="sex" id="sex1" value="男"
                                        <cr:if test="${chxm.sex == '男'}">
                                            checked="checked"
                                        </cr:if> />男
                                    <input type="radio" name="sex" id="sex2" value="女"
                                            <cr:if test="${chxm.sex == '女'}">
                                                checked="checked"
                                            </cr:if> />女
                                </td>
                            </tr>
                            <tr>
                                <td><span>年龄</span></td>
                                <td><input type="text" name="age" id="age" value="${chxm.age}" class="form-control"/>
                                </td>
                            </tr>
                            <tr>
                                <td><span>工作单位</span></td>
                                <td><input type="text" name="workUnit" id="workUnit" value="${chxm.workUnit}"
                                           class="form-control"/></td>
                            </tr>
                            <tr>
                                <td><span>电话</span></td>
                                <td><input type="phoneNum" name="phoneNum" id="phoneNum" value="${chxm.phoneNum}"
                                           class="form-control"/></td>
                            </tr>
                            <tr>
                            ...
                            <tr>
                                ...
                                <td><input type="radio" name="talkWilling" id="talkWilling1" value="是"
                                        <cr:if test="${chxm.talkWilling == '是'}">
                                            checked="checked"
                                        </cr:if> />是
                                    <input type="radio" name="talkWilling" id="talkWilling2" value="否"
                                            <cr:if test="${chxm.talkWilling == '否'}">
                                                checked="checked"
                                            </cr:if>/>否
                                </td>
                            </tr>
                            ...
                            <tr>
                                ...
                                <td><select id="income" class="form-control need" name="income">
                                    <option value="">请选择</option>
                                    <cr:forEach items="${pageScope.incomeList}" var="s">
                                        <option value="${s}"
                                                <cr:if test="${chxm.income eq s}">selected</cr:if>>${s}</option>
                                    </cr:forEach>
                                </select></td>
                            </tr>
                            <tr>
                                ...
                                <td>
                                    <select id="healthFocus" class="form-control need" name="healthFocus">
                                        ...
                                        <cr:forEach items="${pageScope.healthList}" var="s">
                                            <option value="${s}"
                                                    <cr:if test="${chxm.healthFocus eq s}">selected</cr:if>>${s}</option>
                                        </cr:forEach>
                                    </select>
                                </td>
                            </tr>
                                ...
                                <td>
                                    <select id="priceFocus" class="form-control need" name="priceFocus">
                                        ...
                                        <cr:forEach items="${pageScope.priceList}" var="s">
                                            <option value="${s}"
                                                    <cr:if test="${chxm.priceFocus eq s}">selected</cr:if>>${s}</option>
                                        </cr:forEach>
                                    </select>
                                </td>
                            </tr>
                                ...
                                <td>
                                    ...
                                    <select id="brandFocus" class="form-control need" name="brandFocus">
                                        ...
                                        <cr:forEach items="${pageScope.brandList}" var="s">
                                            <option value="${s}"
                                                    <cr:if test="${chxm.brandFocus eq s}">selected</cr:if>>${s}</option>
                                        </cr:forEach>
                                    </select>
                                </td>
                            </tr>
                                ...
                                <td>
                                    <select id="acceptRecommend" class="form-control need" name="acceptRecommend">
                                        ...
                                        <cr:forEach items="${pageScope.acceptList}" var="s">
                                            <option value="${s}"
                                                    <cr:if test="${chxm.acceptRecommend eq s}">selected</cr:if>>${s}</option>
                                        </cr:forEach>
                                    </select>
                                </td>
                            </tr>
                            ...
                            <tr>
                                ...
                                <td><input type="text" name="saleSum" id="saleSum" value="${chxm.saleSum}"
                                           readonly="readonly" class="form-control"/></td>
                            </tr>
                            <tr>
                                <td><span>利润总额</span></td>
                                <td><input type="text" name="profitSum" id="profitSum" value="${chxm.profitSum}"
                                           readonly="readonly" class="form-control"/></td>
                            </tr>
                            <tr>
                                ...
                                <td>
                                    <div class="input-group date form_date" data-date-format="yyyy-mm-dd">
                                        <input type="text" name="lastSaleDate" disabled="disabled"
                                        ...
                                        <span class="input-group-addon" disabled="disabled"> <span
                                                class="glyphicon glyphicon-calendar"  disabled="disabled"></span>
													</span>
                                    </div>
                                </td>
                            </tr>
                                ...
                                <td>
                                    ...
                                    <select id="cardUseType" class="form-control need" name="cardUseType">
                                        ...
                                        <cr:forEach items="${pageScope.useList}" var="s">
                                            <option value="${s}"
                                                    <cr:if test="${chxm.cardUseType eq s}">selected</cr:if>>${s}</option>
                                        </cr:forEach>
                                    </select>
                                </td>
                            </tr>
                            <tr>
                                <td>
                                    <input type="hidden" name="memId" value="${chxm.memId}"/>
                                </td>
                            </tr>
                            </tbody>
                        </table>
...
<script type="text/javascript">
    ...
    $(function () {
        ...
        <%--<cr:forEach items="${chxm.familyList}" var="t">--%>
        <%--familyArray.push(--%>
        <%--        {--%>
        <%--            userType:"${t.userType}",--%>
        <%--            userName:"${t.userName}",--%>
        ...
        $('#tbfamily').bootstrapTable({
            url:"${pageContext.request.contextPath }/chxm/getfamilys/${chxm.memId}",
